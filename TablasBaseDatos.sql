...
(
  ...
  VCOD NUMBER(10),
  PRIMARY KEY (PCOD),
  FOREIGN KEY (UCOD) REFERENCES USUARIO(UCOD) ON DELETE CASCADE,
  FOREIGN KEY (VCOD) REFERENCES VENDEDOR(VCOD) ON DELETE CASCADE
);
...
(
  ...
  SUBC VARCHAR2(50),
  PRIMARY KEY (SUBC),
  FOREIGN KEY (CNAME) REFERENCES CATEGORIA ON DELETE CASCADE
);
...
(
  ...
  CONSTRAINTS MARCA_FK
  FOREIGN KEY (MNAME) 
  REFERENCES MARCA(MNAME)
  ON DELETE CASCADE,
  
  CONSTRAINTS SUBCAT_FK
  FOREIGN KEY (SUBC) 
  REFERENCES SUBCAT(SUBC)
  ON DELETE CASCADE
);
...
(
  ...
  FOREIGN KEY (PCOD) REFERENCES PEDIDO(PCOD) ON DELETE CASCADE,
